...
def main():
    ...
    while True:
        ...
        # raw_choice = 'add', 'find', or 'print'
        if not raw_choice:
            break
    
        given_choice = raw_choice[0].lower()
        # given_choice = 'a', 'f', or 'p'

        # choices = {'add': <function CollectEntries at 0x000001D554D67158>, 
        # 'find': <function FindDefinitions at 0x000001D554D67B70>, 
        # 'print': <function PrintEntries at 0x000001D554D67C80>}
        for maybe_choice in choices: 
            # maybe_choice = add, find, print. maybe_choice[0] = 'a', 'f', 'p'
            if maybe_choice[0] == given_choice:
                # choices[add](), choices[find], choices[print]
